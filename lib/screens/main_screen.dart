      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              print('[DATA] segment 0 : ${segments[0].toMap()}');
              ...
              ? Stack(
                  children: [
                    ...
                    for (var i = 0; i < allItems.length; i++)
                      allItems[allItems.length - 1 - i].circleWidget(scale,
                          action: () {
                        setState(() {
                          ...
                          if (allItems[allItems.length - 1 - i].isExpanded) {
                            ...
                            for (var item in friendSegments) {
                              if (item.id ==
                                  allItems[allItems.length - 1 - i].id) {
                                continue;
                              }
                            ...
                            target = Offset(
                                max(screenX,
                                    allItems[allItems.length - 1 - i].posX),
                                max(screenY,
                                    allItems[allItems.length - 1 - i].posY));
                            setAnimationScale();
                          }
                        });
                      }),
